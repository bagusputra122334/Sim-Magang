            ...
            <div class="panel h-100">
                ...
                <form method="post" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position: relative !important; width: 100% !important; display: block !important;" x-data="{ show: false }">
                            <input :type="show ? 'text' : 'password'" name="current_password" id="update_password_current_password" class="form-control @error('current_password', 'updatePassword') is-invalid @enderror" style="padding-right: 2.5rem !important; box-sizing: border-box !important;" autocomplete="current-password">
                            <button type="button"
                                    @click="show = !show"
                                    style="position: absolute !important; right: 12px !important; top: 50% !important; transform: translateY(-50%) !important; z-index: 10; background: transparent; border: none; cursor: pointer; color: #6c757d; display: flex; align-items: center; justify-content: center; padding: 0; line-height: 1;">
                                <svg x-show="show" style="width: 1.125rem; height: 1.125rem;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                                <svg x-show="!show" style="width: 1.125rem; height: 1.125rem;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.027 10.027 0 014.132-5.411m3.635-1.14A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.027 10.027 0 01-1.413 3.334M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    ...
                    <div class="mb-3">
                        ...
                        <div style="position: relative !important; width: 100% !important; display: block !important;" x-data="{ show: false }">
                            <input :type="show ? 'text' : 'password'" name="password" id="update_password_password" class="form-control @error('password', 'updatePassword') is-invalid @enderror" style="padding-right: 2.5rem !important; box-sizing: border-box !important;" autocomplete="new-password">
                            <button type="button"
                                    @click="show = !show"
                                    style="position: absolute !important; right: 12px !important; top: 50% !important; transform: translateY(-50%) !important; z-index: 10; background: transparent; border: none; cursor: pointer; color: #6c757d; display: flex; align-items: center; justify-content: center; padding: 0; line-height: 1;">
                                <svg x-show="show" style="width: 1.125rem; height: 1.125rem;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="mb-4">
                        ...
                        <div style="position: relative !important; width: 100% !important; display: block !important;" x-data="{ show: false }">
                            <input :type="show ? 'text' : 'password'" name="password_confirmation" id="update_password_password_confirmation" class="form-control @error('password_confirmation', 'updatePassword') is-invalid @enderror" style="padding-right: 2.5rem !important; box-sizing: border-box !important;" autocomplete="new-password">
                            <button type="button"
                                    @click="show = !show"
                                    style="position: absolute !important; right: 12px !important; top: 50% !important; transform: translateY(-50%) !important; z-index: 10; background: transparent; border: none; cursor: pointer; color: #6c757d; display: flex; align-items: center; justify-content: center; padding: 0; line-height: 1;">
                                <svg x-show="show" style="width: 1.125rem; height: 1.125rem;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
