...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            <a href="{{ route('admin.applications.index') }}" class="btn btn-outline-secondary btn-sm px-3 shadow-xs">
                <i class="bi bi-arrow-left me-1"></i> Kembali ke Daftar
            </a>
            @if (! $reg->isAccepted() && ! $reg->isRejected())
                <a href="{{ route('admin.applications.review', $reg->id) }}" class="btn btn-primary btn-sm px-3 shadow-sm fw-semibold">
                        ...
                        <div class="reply-letter-card state-pending p-4 text-center text-md-start">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md-4 text-center text-md-end">
                                    <a href="{{ route('admin.applications.reply-letter', $reg->id) }}"
                                       class="btn btn-primary btn-lg px-4 py-2.5 fw-bold shadow-sm w-100 w-md-auto">
