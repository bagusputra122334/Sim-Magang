...
class UpdateProfileRequest extends FormRequest
{
    ...
    {
        $rawType = strtolower((string) $this->input('participant_type', $this->user()?->profile?->participant_type?->value ?? 'university'));
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nik' => [
                ...
                'numeric',
                'digits:16',
                Rule::unique('profiles', 'nik')->ignore($profileId),
            ],
            'nama_lengkap' => [
                'required',
                'string',
            ...
            'nis_nim' => [
                ...
                'max:50',
                'regex:/^[A-Za-z0-9.\-\/]+$/',
                Rule::unique('profiles', 'nis_nim')->ignore($profileId),
            ],
            'nim' => $isStudent ? ['nullable'] : [
                ...
                'max:30',
                'regex:/^[A-Za-z0-9.\-\/]+$/',
                Rule::unique('profiles', 'nim')->ignore($profileId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'nis_nim.unique'            => 'NIS / NIM ini sudah dipakai peserta lain.',
