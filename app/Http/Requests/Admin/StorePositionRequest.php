...
class StorePositionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'nama_posisi' => [
                ...
                'string',
                'max:100',
                Rule::unique('positions', 'nama_posisi')->whereNull('deleted_at'),
            ],
            'slug' => [
                'required',
                'string',
                'max:150',
                'alpha_dash',
                Rule::unique('positions', 'slug')->whereNull('deleted_at'),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'nama_posisi.unique'      => 'Nama posisi ini sudah ada, silakan gunakan nama lain.',
            ...
            'kuota.integer'        => 'Kuota harus berupa bilangan bulat (angka).',
            'kuota.min'          => 'Kuota minimal 1 orang.',
            'kuota.max'          => 'Kuota maksimal 500 orang per posisi.',
